...
(function () {
  ...
  var STR = [
    ...
    ['#courses .grid-3 article:nth-of-type(1) .badge--level', 'Beginner / Intermediate', 'Iniciante / Intermedi\u00e1rio'],
    ['#courses .grid-3 article:nth-of-type(2) .badge--level', 'Intermediate', 'Intermedi\u00e1rio'],
    ['#courses .grid-3 article:nth-of-type(3) .badge--level', 'Beginner / Intermediate', 'Iniciante / Intermedi\u00e1rio'],
    ['#courses .grid-3 article:nth-of-type(1) .course-card__body > p', 'From concept to finished sculpt, the complete process for designing and sculpting original stylized characters.', 'Do conceito ao sculpt finalizado, o processo completo para desenhar e esculpir personagens estilizados originais.'],
    ['#courses .grid-3 article:nth-of-type(2) .course-card__body > p', 'Clean, animation-ready topology without the pain. The retopology stage explained from start to finish.', 'Topologia limpa e pronta para anima\u00e7\u00e3o, sem sofrimento. A etapa de retopologia explicada do in\u00edcio ao fim.'],
    ['#courses .grid-3 article:nth-of-type(3) .course-card__body > p', 'Design and sculpt an appealing creature from scratch, balancing anatomy, charm and strong shape language.', 'Desenhe e esculpa uma criatura cheia de apelo do zero, equilibrando anatomia, carisma e uma linguagem de formas forte.'],
