...
(function () {
  ...
  var DICT = [
    ...
    { s: '.hero__badges .badge--neutral', en: 'Season 2 &middot; No deadline', pt: 'Season 2 &middot; Sem prazo' },
    ...
    { s: '.hero__sub', en: 'Direct one-on-one guidance from a Senior 3D Character Artist working inside real studios, until your character is finished. Your work, on screen, every single week.', pt: 'Orienta&ccedil;&atilde;o direta, one-on-one, com um Senior 3D Character Artist que trabalha dentro de est&uacute;dios reais, at&eacute; o seu personagem ficar pronto. Seu trabalho, na tela, toda semana.' },
    ...
    { s: '#compare .compare__card--highlight li:nth-child(2)', en: 'A Senior Artist correcting your course every session.', pt: 'Um Senior Artist corrigindo seu rumo em cada sess&atilde;o.' },
    { s: '#compare .compare__card--highlight li:nth-child(3)', en: 'Structured path with a finished piece at the end, no deadline.', pt: 'Trilha estruturada com uma pe&ccedil;a finalizada no fim, sem prazo.' },

    /* how it works */
    { s: '#how .eyebrow', en: 'How it works', pt: 'Como funciona' },
    { s: '#how .section__head h2', en: 'A simple rhythm, built around you.', pt: 'Um ritmo simples, constru&iacute;do em torno de voc&ecirc;.' },
    { s: '#how .how-card:nth-child(1) .how-card__step', en: 'Every week', pt: 'Toda semana' },
    { s: '#how .how-card:nth-child(1) h3', en: 'Live 1-on-1 sessions', pt: 'Sess&otilde;es 1-on-1 ao vivo' },
    { s: '#how .how-card:nth-child(1) p', en: 'Up to two live sessions a week on Google Meet, just you and Vini, booked in your time zone.', pt: 'At&eacute; duas sess&otilde;es ao vivo por semana no Google Meet, s&oacute; voc&ecirc; e o Vini, agendadas no seu fuso hor&aacute;rio.' },
    ...
    { s: '#how .how-card:nth-child(3) p', en: 'Each stage comes with lessons on the platform, yours for life, so session time goes to your work.', pt: 'Cada etapa vem com aulas na plataforma, suas para sempre, ent&atilde;o o tempo de sess&atilde;o vai para o seu trabalho.' },
    { s: '#how .how-card:nth-child(4) .how-card__step', en: 'At the end', pt: 'No fim' },
    ...
    { s: '#schedule .section__head h2', en: 'The stage-by-stage journey', pt: 'A jornada etapa por etapa' },
    { s: '#schedule .section__lead', en: 'A complete character pipeline: sculpture in ZBrush and Blender, texturing in Substance Painter, grooming and rendering in Houdini. The plan runs in ten stages and the pace adapts to you: there is no fixed end date, and your sessions keep going until the character is finished.', pt: 'Um pipeline completo de personagem: escultura no ZBrush e Blender, texturiza&ccedil;&atilde;o no Substance Painter, grooming e render no Houdini. O plano roda em dez etapas e o ritmo se adapta a voc&ecirc;: n&atilde;o existe data final fixa, e as suas sess&otilde;es continuam at&eacute; o personagem ficar pronto.' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(1) .week-card__label', en: 'Stage 1', pt: 'Etapa 1' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(2) .week-card__label', en: 'Stage 2', pt: 'Etapa 2' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(3) .week-card__label', en: 'Stage 3', pt: 'Etapa 3' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(4) .week-card__label', en: 'Stage 4', pt: 'Etapa 4' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(5) .week-card__label', en: 'Stage 5', pt: 'Etapa 5' },
    ...
    { s: '#schedule .module:nth-of-type(1) .week-card:nth-child(6) .week-card__label', en: 'Stage 6', pt: 'Etapa 6' },
    ...
    { s: '#schedule .module:nth-of-type(2) .week-card:nth-child(1) .week-card__label', en: 'Stage 7', pt: 'Etapa 7' },
    ...
    { s: '#schedule .module:nth-of-type(2) .week-card:nth-child(2) .week-card__label', en: 'Stage 8', pt: 'Etapa 8' },
    ...
    { s: '#schedule .module:nth-of-type(2) .week-card:nth-child(3) .week-card__label', en: 'Stage 9', pt: 'Etapa 9' },
    ...
    { s: '.fit__card--yes li:nth-child(3)', en: 'You can commit a few hours per week until the character is finished, with ZBrush and Blender installed (Houdini optional). No prior experience level required.', pt: 'Voc&ecirc; consegue dedicar algumas horas por semana at&eacute; o personagem ficar pronto, com ZBrush e Blender instalados (Houdini opcional). Nenhum n&iacute;vel de experi&ecirc;ncia pr&eacute;vio exigido.' },
    { s: '.fit__result', en: '<strong>Your result:</strong> one complete stylized character, blockout to final render, reviewed at every stage by a Senior Artist.', pt: '<strong>Seu resultado:</strong> um personagem estilizado completo, do blockout ao render final, revisado em cada etapa por um Senior Artist.' },
    ...
    { s: '#lifetime .lifetime__card:nth-of-type(2) p', en: 'Up to two live one-on-ones every week, for as long as your character takes.', pt: 'At&eacute; dois one-on-one ao vivo por semana, pelo tempo que o seu personagem levar.' },
    ...
    { s: '#pricing .pricing__includes li:nth-child(1)', en: 'One-on-one mentorship until your character is done', pt: 'Mentoria one-on-one at&eacute; o seu personagem ficar pronto' },
    { s: '#pricing .pricing__includes li:nth-child(2)', en: 'Up to 2 live feedback sessions per week, booked in your time zone', pt: 'At&eacute; 2 sess&otilde;es de feedback ao vivo por semana, agendadas no seu fuso' },
    ...
    { s: '#pricing .pricing__includes li:nth-child(4)', en: 'Structured lessons on the learning platform', pt: 'Aulas estruturadas na plataforma' },
    ...
    { s: '.faq__item:nth-of-type(3) .faq__answer', en: 'Sessions run on Google Meet. You can book up to two sessions a week through a scheduling link, picking the times that work best in your time zone. Mentees in Europe and North America are fully supported.', pt: 'As sess&otilde;es acontecem no Google Meet. Voc&ecirc; pode agendar at&eacute; duas sess&otilde;es por semana por um link, escolhendo os hor&aacute;rios que funcionam melhor no seu fuso. Mentorados na Europa e Am&eacute;rica do Norte s&atilde;o totalmente atendidos.' },
    { s: '.faq__item:nth-of-type(4) .faq__q', en: 'How much does it cost and how do I pay?', pt: 'Quanto custa e como eu pago?' },
    { s: '.faq__item:nth-of-type(4) .faq__answer', en: 'The full program is $600, paid once or split into 3 payments. Checkout is processed securely and international cards are accepted. For comparison: a single mentored course at the big online schools runs $600&ndash;$1,200, with one instructor shared across a full class.', pt: 'O programa completo custa $600, em pagamento &uacute;nico ou dividido em 3x. O checkout &eacute; processado com seguran&ccedil;a e cart&otilde;es internacionais s&atilde;o aceitos. Para comparar: um &uacute;nico curso mentorado nas grandes escolas online sai por $600&ndash;$1.200, com um instrutor dividido entre a turma inteira.' },

    /* final cta */
    { s: '.final-cta h2', en: 'You either finish the character. Or you add another folder of WIPs.', pt: 'Ou voc&ecirc; finaliza o personagem. Ou voc&ecirc; adiciona mais uma pasta de WIPs.' },
