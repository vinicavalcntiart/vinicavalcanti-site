...
(function () {
  ...
  var STR = [
    ...
    ['#included p', 'Never touched ZBrush? This course already includes the full <strong>Intro to ZBrush: Mushroom</strong> course <strong>($19 value)</strong>: 13 lessons from absolute zero, so you arrive at the stylized pipeline ready.', 'Nunca mexeu no ZBrush? Este curso já inclui o curso completo <strong>Intro to ZBrush: Mushroom</strong> <strong>(valor de $19)</strong>: 13 aulas do zero absoluto, para você chegar pronto ao pipeline estilizado.'],
