...
(function () {
  ...
  var STR = [
    ...
    ['.hero__sub', 'Your first steps in ZBrush, one concept at a time — from opening the software for the first time to your first complete character, sculpted, painted and rendered.', 'Seus primeiros passos no ZBrush, um conceito de cada vez — de abrir o software pela primeira vez ao seu primeiro personagem completo, esculpido, pintado e renderizado.'],
    ...
    ['.hero__media-caption', 'The character you\'ll build in this course — sculpted, painted and rendered.', 'O personagem que você vai construir neste curso — esculpido, pintado e renderizado.'],
    ...
    ['#modules .section__lead', 'Every lesson states its goal upfront and ends with a self-check — you always know if you\'re ready to move on. Lessons 1–8 build the foundations, tool by tool. Lessons 9–12 are the final project, where everything comes together.', 'Cada aula declara seu objetivo logo no início e termina com uma autoavaliação — você sempre sabe se está pronto para avançar. As aulas 1–8 constroem os fundamentos, ferramenta por ferramenta. As aulas 9–12 são o projeto final, onde tudo se aplica.'],
    ...
    ['#grid-foundations article:nth-of-type(5) p', 'Move, scale and rotate with precision — plus canvas setup that helps you.', 'Mova, escale e rotacione com precisão — além do setup de canvas que trabalha a seu favor.'],
    ...
    ['#next-steps .section__lead', 'When you finish the mushroom, these are the next steps — and both already include this course for free.', 'Quando você terminar o cogumelo, estes são os próximos passos — e os dois já incluem este curso de graça.'],
    ['#next-steps .next-steps__card:nth-of-type(1) h3', 'ZBrush for Stylized Characters', 'ZBrush for Stylized Characters'],
    ['#next-steps .next-steps__card:nth-of-type(1) > p:nth-of-type(1)', 'From concept to finished sculpt — the complete process for designing original stylized characters with an identity of their own.', 'Do conceito ao sculpt finalizado — o processo completo para criar personagens estilizados originais com identidade própria.'],
    ...
    ['#next-steps .next-steps__card:nth-of-type(2) > p:nth-of-type(1)', 'Ten weeks of direct, one-on-one guidance from a Senior Character Artist — finish a portfolio-ready character with feedback every week.', 'Dez semanas de orientação direta e individual de um Senior Character Artist — finalize um personagem de portfólio com feedback toda semana.'],
    ...
    ['#faq .faq__item:nth-of-type(6) .faq__answer', 'You have a 15-day money-back guarantee after purchase — plenty of time to explore the content and decide whether it\'s the right fit for you.', 'Você tem garantia de reembolso de 15 dias após a compra — tempo de sobra para explorar o conteúdo e decidir se é para você.'],
    ...
    ['.final-cta .container > p', 'The lowest-risk way to find out if 3D character art is for you.', 'O jeito de menor risco de descobrir se arte de personagens 3D é para você.'],
    ['#final-buy', 'Get this course — $19', 'Quero este curso — $19'],
